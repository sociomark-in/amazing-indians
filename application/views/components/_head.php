...
<link rel="apple-touch-icon" sizes="180x180" href="<?= base_url("assets/media/favicons2/") ?>apple-touch-icon.png">
<link rel="icon" type="image/png" sizes="32x32" href="<?= base_url("assets/media/favicons2/") ?>favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="<?= base_url("assets/media/favicons2/") ?>favicon-16x16.png">
<link rel="manifest" href="<?= base_url("assets/media/favicons2/") ?>site.webmanifest">
...
<!-- Prefetch -->
<link rel="prefetch" href="<?= base_url('assets/media/backgrounds/background.gif') ?>" />
<!-- Prefetch -->
